package com.example.amazontextract.service.textract.util;
...
public class TextractTableGenerator {
    ...
    private TextractTableGenerator() {}

    public static String[][] generateTableFromRelationship(List<Relationship> relationships, List<Block> cellBlocks, List<Block> lineBlocks) {
                        ...
                        if (cell != null) {
                            ...
                            if (relationshipsCell != null && !relationshipsCell.isEmpty()) {
                                ...
                                do {
                                    ...
                                    Block lineBlockRelated =
                                            lineBlocks.stream().filter(lineBlock -> lineBlock.relationships().get(0).ids().contains(firstRelationship)).findFirst().orElse(null);
